...
import com.nimble.lupin.pu_manager.adapters.BottomAdapter
...
import com.nimble.lupin.pu_manager.databinding.FragmentPostBottomSheetBinding
...
class BottomSheet(
   ...
   public fun updateList(  newList: MutableList<BottomSheetModel>){
    ...
    fun getTasksList(){
        ...
        isLoading = true
        taskCall?.cancel()
        taskCall = apiService.getManagerTaskToAssign(Constants.AdminWorkStation_ID,page, searchKey)
